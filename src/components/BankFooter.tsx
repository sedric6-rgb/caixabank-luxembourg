      ...
      <div className="border-t border-white/10">
        <div className="wrap py-6">
          <div className="flex flex-col gap-4 text-xs text-white/50 sm:flex-row sm:items-center sm:justify-between">
            <span className="flex items-center gap-2"><img src="/logo-caixa.png" alt="" width={20} height={20} className="h-5 w-5 opacity-60" />&copy; 2024 CaixaBank Luxembourg S.A. — Banque Privée. Tous droits reserves.</span>
