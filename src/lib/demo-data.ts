...
export const DEMO_CLIENTS: DemoClient[] = [
  {
    ...
    transactions: [
      ...
      { date: "15/09/2026", desc: "Entreprise ABC — Salaire", amount: 4500 },
      { date: "14/09/2026", desc: "Delhaize", amount: -42.3 },
      { date: "14/09/2026", desc: "Credit Immobilier CBL", amount: -1567.23 },
      { date: "13/09/2026", desc: "Fournisseur XYZ S.a r.l.", amount: -8500 },
      { date: "13/09/2026", desc: "Interets Livret Epargne", amount: 122.34 },
    ],
  },
  {
    ...
    transactions: [
      ...
      { date: "14/09/2026", desc: "Salaire — Societe ABC", amount: 3800 },
      { date: "13/09/2026", desc: "Loyer appartement", amount: -1450 },
      { date: "12/09/2026", desc: "Transfert epargne", amount: -500 },
    ],
  },
  {
    ...
    transactions: [
      ...
      { date: "14/09/2026", desc: "Fournitures bureau", amount: -345.60 },
      { date: "13/09/2026", desc: "Assurance pro", amount: -890 },
      { date: "12/09/2026", desc: "Facture IT Services", amount: -2100 },
      { date: "11/09/2026", desc: "Reglement facture #4521", amount: 8400 },
    ],
  },
  {
    ...
    id_type: "Carte d'identite", id_number: "CMP 582710", status: "en_attente", created_at: "01/09/2026",
    accounts: [
  ...
  },
  {
    ...
    transactions: [
      ...
      { date: "14/09/2026", desc: "Encaissement facture #7832", amount: 18900 },
      { date: "13/09/2026", desc: "Charges sociales Q3", amount: -4200 },
      { date: "12/09/2026", desc: "TVA recuperee", amount: 3150 },
    ],
  },
  {
  ...
  },
  {
    ...
    id_type: "Passeport", id_number: "GH 1029384", status: "actif", created_at: "27/04/2026",
    accounts: [
    ...
    transactions: [
      ...
      { date: "14/09/2026", desc: "Loyer", amount: -1600 },
      { date: "13/09/2026", desc: "Restaurant", amount: -65.40 },
    ],
  },
  {
    ...
    transactions: [
      ...
      { date: "14/09/2026", desc: "Assurance habitation", amount: -245 },
      { date: "13/09/2026", desc: "Courses Cactus", amount: -178.90 },
      { date: "12/09/2026", desc: "Transfert vers epargne", amount: -2000 },
      { date: "11/09/2026", desc: "Abonnement fitness", amount: -49.90 },
    ],
  },
  {
    ...
    transactions: [
      ...
      { date: "14/09/2026", desc: "Monoprix", amount: -96.30 },
      { date: "13/09/2026", desc: "Loyer appartement", amount: -1350 },
      { date: "12/09/2026", desc: "EDF Electricite", amount: -127.50 },
    ],
  },
  {
    ...
    transactions: [
      ...
      { date: "14/09/2026", desc: "Fournitures informatiques", amount: -1890 },
      { date: "13/09/2026", desc: "Restaurant Le Bouquet", amount: -142.50 },
      { date: "12/09/2026", desc: "Assurance vehicule", amount: -380 },
      { date: "11/09/2026", desc: "Cotisations sociales", amount: -2450 },
    ],
  },
  {
    ...
    id_type: "Carte d'identite", id_number: "GKL 582039", status: "actif", created_at: "02/03/2026",
    accounts: [
    ...
    transactions: [
      ...
      { date: "14/09/2026", desc: "Zara", amount: -189.90 },
      { date: "13/09/2026", desc: "Spotify Premium", amount: -9.99 },
      { date: "12/09/2026", desc: "Pharmacie", amount: -34.50 },
    ],
  },
  {
    ...
    transactions: [
      ...
      { date: "14/09/2026", desc: "Auchan Cloche d'Or", amount: -215.40 },
      { date: "13/09/2026", desc: "Assurance vie", amount: -320 },
      { date: "12/09/2026", desc: "Virement famille", amount: -800 },
      { date: "11/09/2026", desc: "Parking LuxExpo", amount: -12 },
    ],
  },
  {
    ...
    id_type: "Carte d'identite", id_number: "HMN 472910", status: "en_attente", created_at: "10/09/2026",
    accounts: [
  ...
  },
  {
    ...
    transactions: [
      ...
      { date: "14/09/2026", desc: "Notaire — acte vente", amount: -12400 },
      { date: "13/09/2026", desc: "Taxe fonciere", amount: -1870 },
      { date: "12/09/2026", desc: "Dividendes SCI Schmit", amount: 15000 },
      { date: "11/09/2026", desc: "Entretien immeubles", amount: -3200 },
      { date: "10/09/2026", desc: "Credit immobilier mensualite", amount: -4567.89 },
    ],
  },
  {
    ...
    id_type: "Passeport", id_number: "MA 5829301", status: "actif", created_at: "16/01/2026",
    accounts: [
    ...
    transactions: [
      ...
      { date: "14/09/2026", desc: "Delhaize Kirchberg", amount: -134.70 },
      { date: "13/09/2026", desc: "Abonnement transport CFL", amount: -75 },
      { date: "12/09/2026", desc: "Western Union — virement", amount: -500 },
    ],
  },
  {
  ...
  },
  {
    ...
    id_type: "Passeport", id_number: "RU 7382910", status: "actif", created_at: "30/05/2026",
    accounts: [
    ...
    transactions: [
      ...
      { date: "14/09/2026", desc: "IKEA Arlon", amount: -567.80 },
      { date: "13/09/2026", desc: "Netflix", amount: -15.49 },
      { date: "12/09/2026", desc: "Uber", amount: -23.40 },
    ],
  },
  {
    ...
    transactions: [
      ...
      { date: "14/09/2026", desc: "Leasing Mercedes", amount: -890 },
      { date: "13/09/2026", desc: "Restaurant Clairefontaine", amount: -285 },
      { date: "12/09/2026", desc: "Expert comptable", amount: -1500 },
      { date: "11/09/2026", desc: "Charges bureau Kirchberg", amount: -2100 },
      { date: "10/09/2026", desc: "Salaire employe", amount: -4200 },
    ],
  },
  {
    ...
    transactions: [
      ...
      { date: "14/09/2026", desc: "Assurance premium", amount: -1200 },
      { date: "13/09/2026", desc: "Virement sortant", amount: -8500 },
    ],
  },
  {
    ...
    transactions: [
      ...
      { date: "14/09/2026", desc: "Gestion patrimoine", amount: -3500 },
      { date: "13/09/2026", desc: "Virement international", amount: -15000 },
    ],
  },
  {
  ...
  },
  {
    ...
    transactions: [
      ...
      { date: "12/09/2026", desc: "Dividendes portefeuille", amount: 12500 },
