...
function buildInitialLoans(): Loan[] {
  return [
    ...
    { id: 2, clientId: 2, client: "Philippe Martelly", type: "Professionnel", amount: 120000, rate: "4,10", duration: "7 ans", status: "en_cours", date: "15/01/2024", mensualite: calcMensualite(120000, "4,10", 7) },
