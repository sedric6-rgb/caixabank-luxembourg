...
function buildInitialInsurances(): Insurance[] {
  return [
    ...
    { id: 3, clientId: 2, client: "François Martelly", type: "Auto", formule: "Tous risques", prime: 180, couverture: 120000, status: "active", debut: "01/01/2024", echeance: "01/01/2025" },
